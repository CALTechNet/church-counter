...
def enhance_image(image: np.ndarray) -> np.ndarray:
    ...
    The stitcher already applies a gamma-1.8 brightness boost to the panorama,
    so this provides additional per-tile local contrast enhancement on top.
    """
    ...
    # Additional gamma lift — complementary to stitcher's gamma 1.8
    gamma = 1.5
